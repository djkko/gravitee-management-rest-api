...
public class SubscriptionServiceTest {
    ...
    public void shouldCreateWithoutProcess_AcceptedGCU() throws Exception {
        ...
        newSubscriptionEntity.setGeneralConditionsRef(plan.getGeneralConditions()+"-1");
        ...
        assertNotEquals(plan.getGeneralConditions(), capturedSuscription.getGeneralConditionsRef());
        assertEquals(newSubscriptionEntity.getGeneralConditionsRef(), capturedSuscription.getGeneralConditionsRef());
        assertEquals(newSubscriptionEntity.getGeneralConditionsAccepted(), capturedSuscription.getGeneralConditionsAccepted());
        assertEquals(newSubscriptionEntity.getGeneralConditionsContent(), capturedSuscription.getGeneralConditionsContent());
    ...
    public void shouldNotCreateWithoutProcess_NotAcceptedGCU() throws Exception {
        ...
        final NewSubscriptionEntity newSubscriptionEntity = new NewSubscriptionEntity(PLAN_ID, APPLICATION_ID);
        newSubscriptionEntity.setGeneralConditionsContent("## Some Markdown Content");
        newSubscriptionEntity.setGeneralConditionsRef(PAGE_ID);
    ...
    @Test(expected = PlanGeneralConditionAcceptedException.class)
    public void shouldNotCreateWithoutProcess_AcceptedGCU_WithoutGCURef() throws Exception {
        // Prepare data
        when(plan.getGeneralConditions()).thenReturn(PAGE_ID);
        ...
        // Run
        final NewSubscriptionEntity newSubscriptionEntity = new NewSubscriptionEntity(PLAN_ID, APPLICATION_ID);
        newSubscriptionEntity.setGeneralConditionsContent("Some");
        newSubscriptionEntity.setGeneralConditionsRef("");
        newSubscriptionEntity.setGeneralConditionsAccepted(true);
        subscriptionService.create(newSubscriptionEntity);
    }
